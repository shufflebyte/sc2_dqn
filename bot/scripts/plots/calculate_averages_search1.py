...
results = [
    ...
    {'file': '/Users/florian/ray_results/DQN151/DQN_srv_2019-07-12_21-43-20zjmi3w_d/progress.csv', 'label': {'search1': 'train batch size = 256', 'search2': 'gamma = 0.8'}},
    {'file': '/Users/florian/ray_results/DQN152/DQN_srv_2019-07-12_21-44-24jav3ghjw/progress.csv', 'label': {'search1': 'train batch size = 256', 'search2': 'gamma = 0.8'}},
    {'file': '/Users/florian/ray_results/DQN153/DQN_srv_2019-07-13_12-12-53a_hct11s/progress.csv', 'label': {'search1': 'train batch size = 256', 'search2': 'gamma = 0.8'}},
    {'file': '/Users/florian/ray_results/DQN154/DQN_srv_2019-07-13_12-14-14w8p_94lr/progress.csv', 'label': {'search1': 'train batch size = 256', 'search2': 'gamma = 0.8'}},
    {'file': '/Users/florian/ray_results/DQN155/DQN_srv_2019-07-14_09-44-19r2diknjy/progress.csv', 'label': {'search1': 'train batch size = 256', 'search2': 'gamma = 0.8'}},
    {'file': '/Users/florian/ray_results/DQN156/DQN_srv_2019-07-14_09-45-24kywh6080/progress.csv', 'label': {'search1': 'train batch size = 256', 'search2': 'gamma = 0.8'}},
    {'file': '/Users/florian/ray_results/DQN157/DQN_srv_2019-07-14_13-00-39gxmpvk38/progress.csv', 'label': {'search1': 'train batch size = 256', 'search2': 'gamma = 0.8'}},
    {'file': '/Users/florian/ray_results/DQN158/DQN_srv_2019-07-14_13-01-47mcc97f8d/progress.csv', 'label': {'search1': 'train batch size = 256', 'search2': 'gamma = 0.8'}},
    {'file': '/Users/florian/ray_results/DQN159/DQN_srv_2019-07-14_16-11-04z1qkfb_h/progress.csv', 'label': {'search1': 'train batch size = 256', 'search2': 'gamma = 0.8'}},
    {'file': '/Users/florian/ray_results/DQN160/DQN_srv_2019-07-14_16-12-15l4_j6485/progress.csv', 'label': {'search1': 'train batch size = 256', 'search2': 'gamma = 0.8'}},
]
