...
results = [
    ...
    {'file': '/Users/florian/ray_results/DQN190/DQN_srv_2019-08-08_09-05-508asornpd/progress.csv', 'label': {'search4': "DDQN"}},
    {'file': '/Users/florian/ray_results/DQN191/APEX_srv_2019-08-08_12-37-44x7knf89v/progress.csv', 'label': {'search5': "APEX"}},
    {'file': '/Users/florian/ray_results/DQN192/APEX_srv_2019-08-08_12-38-50w9_dess7/progress.csv', 'label': {'search5': "APEX"}},
    {'file': '/Users/florian/ray_results/DQN193/APEX_srv_2019-08-08_16-13-43epgtosnq/progress.csv', 'label': {'search5': "APEX"}},
    {'file': '/Users/florian/ray_results/DQN194/APEX_srv_2019-08-08_16-14-510pppdq9p/progress.csv', 'label': {'search5': "APEX"}},
    {'file': '/Users/florian/ray_results/DQN195/APEX_srv_2019-08-09_10-21-16r1mowjon/progress.csv', 'label': {'search5': "APEX"}},
    {'file': '/Users/florian/ray_results/DQN196/APEX_srv_2019-08-09_10-22-14nycuxb9t/progress.csv', 'label': {'search5': "APEX"}},
    {'file': '/Users/florian/ray_results/DQN197/APEX_srv_2019-08-09_14-25-473xcnjr1q/progress.csv', 'label': {'search5': "APEX"}},
    {'file': '/Users/florian/ray_results/DQN198/APEX_srv_2019-08-09_14-26-491aez5omq/progress.csv', 'label': {'search5': "APEX"}},
    {'file': '/Users/florian/ray_results/DQN199/APEX_srv_2019-08-09_17-45-40_q9oxrw6/progress.csv', 'label': {'search5': "APEX"}},
    {'file': '/Users/florian/ray_results/DQN200/APEX_srv_2019-08-09_17-46-411e21j_q9/progress.csv', 'label': {'search5': "APEX"}},
]
...
for result in results:
    # add best DQN graph
    if result['file'] == '/Users/florian/ray_results/DQN177/DQN_srv_2019-08-04_08-47-50q2cvpiqh/progress.csv':
        ...
        plt.plot(df['seconds'] / 60 / 60, df['reward_mean'], label='DQN')

    # add best DDQN graph
    if result['file'] == '/Users/florian/ray_results/DQN188/DQN_srv_2019-08-07_22-18-03mcmrq2wl/progress.csv':
        print("Processing dataset ")
        ...
        plt.plot(df['seconds'] / 60 / 60, df['reward_mean'], label='DDQN')

    # add best Ape-x graph
    if result['file'] == '/Users/florian/ray_results/DQN194/APEX_srv_2019-08-08_16-14-510pppdq9p/progress.csv':
        print("Processing dataset ")
        ...
        plt.plot(df['seconds'] / 60 / 60, df['reward_mean'], label='Ape-x DQN')
...
plt.title("comparison of tuned DQN, DDQN and Ape-X")
