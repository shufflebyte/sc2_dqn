...
plt.plot(df_all_data.index.values/60/60, df_all_data['mean'], label='DQN average')
# print(df_all_data)

# add best dqn graph
file = '/Users/florian/ray_results/DQN177/DQN_srv_2019-08-04_08-47-50q2cvpiqh/progress.csv'
...
plt.plot(df['seconds'] / 60 / 60, df['reward_mean'], label='DQN best')
