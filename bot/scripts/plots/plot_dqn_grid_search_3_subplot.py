...
results = [
    ...
    {'file': '/Users/florian/ray_results/DQN161/DQN_srv_2019-07-30_13-20-24n72_o9a7/progress.csv', 'label': {'search1': 'train batch size = 256', 'search2': 'gamma = 0.8', 'search3': "lr = 0.001"}},
    {'file': '/Users/florian/ray_results/DQN162/DQN_srv_2019-07-30_13-21-58io5ws5xn/progress.csv', 'label': {'search1': 'train batch size = 256', 'search2': 'gamma = 0.8', 'search3': "lr = 0.001"}},
    {'file': '/Users/florian/ray_results/DQN163/DQN_srv_2019-07-30_16-34-41boj29s2i/progress.csv', 'label': {'search1': 'train batch size = 256', 'search2': 'gamma = 0.8', 'search3': "lr = 0.001"}},
    {'file': '/Users/florian/ray_results/DQN164/DQN_srv_2019-07-30_16-36-555a2rer8m/progress.csv', 'label': {'search1': 'train batch size = 256', 'search2': 'gamma = 0.8', 'search3': "lr = 0.001"}},
    {'file': '/Users/florian/ray_results/DQN165/DQN_srv_2019-07-30_20-49-12z2pv57bo/progress.csv', 'label': {'search1': 'train batch size = 256', 'search2': 'gamma = 0.8', 'search3': "lr = 0.001"}},
    {'file': '/Users/florian/ray_results/DQN166/DQN_srv_2019-07-30_20-50-481zr3cs_j/progress.csv', 'label': {'search1': 'train batch size = 256', 'search2': 'gamma = 0.8', 'search3': "lr = 0.001"}},
    {'file': '/Users/florian/ray_results/DQN167/DQN_srv_2019-07-31_00-06-569migwwb_/progress.csv', 'label': {'search1': 'train batch size = 256', 'search2': 'gamma = 0.8', 'search3': "lr = 0.001"}},
    {'file': '/Users/florian/ray_results/DQN168/DQN_srv_2019-07-31_00-08-33vi8cgi96/progress.csv', 'label': {'search1': 'train batch size = 256', 'search2': 'gamma = 0.8', 'search3': "lr = 0.001"}},
    {'file': '/Users/florian/ray_results/DQN169/DQN_srv_2019-07-31_07-52-16gwjbb_ij/progress.csv', 'label': {'search1': 'train batch size = 256', 'search2': 'gamma = 0.8', 'search3': "lr = 0.001"}},
    {'file': '/Users/florian/ray_results/DQN170/DQN_srv_2019-07-31_07-53-22wez0u5cd/progress.csv', 'label': {'search1': 'train batch size = 256', 'search2': 'gamma = 0.8', 'search3': "lr = 0.001"}},
    {'file': '/Users/florian/ray_results/DQN171/DQN_srv_2019-08-03_12-05-55az7up74h/progress.csv', 'label': {'search1': 'train batch size = 256', 'search2': 'gamma = 0.8', 'search3': "lr = 0.01"}},
    {'file': '/Users/florian/ray_results/DQN172/DQN_srv_2019-08-03_12-06-37jkzs_qvx/progress.csv', 'label': {'search1': 'train batch size = 256', 'search2': 'gamma = 0.8', 'search3': "lr = 0.01"}},
    {'file': '/Users/florian/ray_results/DQN173/DQN_srv_2019-08-03_18-50-5675pq7r8f/progress.csv', 'label': {'search1': 'train batch size = 256', 'search2': 'gamma = 0.8', 'search3': "lr = 0.01"}},
    {'file': '/Users/florian/ray_results/DQN174/DQN_srv_2019-08-03_18-52-00caok_kob/progress.csv', 'label': {'search1': 'train batch size = 256', 'search2': 'gamma = 0.8', 'search3': "lr = 0.01"}},
    {'file': '/Users/florian/ray_results/DQN175/DQN_srv_2019-08-04_00-01-18l96sa1rm/progress.csv', 'label': {'search1': 'train batch size = 256', 'search2': 'gamma = 0.8', 'search3': "lr = 0.01"}},
    {'file': '/Users/florian/ray_results/DQN176/DQN_srv_2019-08-04_00-02-498bs_ofv8/progress.csv', 'label': {'search1': 'train batch size = 256', 'search2': 'gamma = 0.8', 'search3': "lr = 0.01"}},
    {'file': '/Users/florian/ray_results/DQN177/DQN_srv_2019-08-04_08-47-50q2cvpiqh/progress.csv', 'label': {'search1': 'train batch size = 256', 'search2': 'gamma = 0.8', 'search3': "lr = 0.01"}},
    {'file': '/Users/florian/ray_results/DQN178/DQN_srv_2019-08-04_08-49-17sa52da31/progress.csv', 'label': {'search1': 'train batch size = 256', 'search2': 'gamma = 0.8', 'search3': "lr = 0.01"}},
    {'file': '/Users/florian/ray_results/DQN179/DQN_srv_2019-08-04_12-37-12qikscbn0/progress.csv', 'label': {'search1': 'train batch size = 256', 'search2': 'gamma = 0.8', 'search3': "lr = 0.01"}},
    {'file': '/Users/florian/ray_results/DQN180/DQN_srv_2019-08-04_12-38-31yt7xnx5l/progress.csv', 'label': {'search1': 'train batch size = 256', 'search2': 'gamma = 0.8', 'search3': "lr = 0.01"}},
]
