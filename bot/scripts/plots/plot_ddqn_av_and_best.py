...
plt.plot(df_all_data.index.values/60/60, df_all_data['mean'], label='DDQN average')
# print(df_all_data)

# add best DDQN graph
file = '/Users/florian/ray_results/DQN188/DQN_srv_2019-08-07_22-18-03mcmrq2wl/progress.csv'
...
plt.plot(df['seconds'] / 60 / 60, df['reward_mean'], label='DDQN best')
